...
def get_open_data():
    open_data = {
        'beratung': {
            ...
            'r9': len(frappe.get_list('Beratung', fields='name', filters={'status': ['not in', ['Rückfragen', 'Open', 'Zusammengeführt']], 'ungelesen': 1, 'kontaktperson': ['is', 'set'], 'hat_termine': 0, 'sektion_id': ['!=', 'MVDF']}, limit=100, distinct=True)),
