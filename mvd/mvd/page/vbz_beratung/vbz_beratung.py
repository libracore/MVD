...
def get_open_data():
    open_data = {
        'beratung': {
            ...
            'r2': len(frappe.get_list('Beratung', fields='name', filters={'status': 'Open', 'beratung_prio': ['!=', 'Hoch'], 'kontaktperson': 'Rechtsberatung Pool (MVBE)'}, limit=100, distinct=True, ignore_ifnull=True)),
