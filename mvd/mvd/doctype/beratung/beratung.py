...
def _should_create_new_beratung_from_mail(beratung):
    ...
    # Prüfung ob Feature deaktiviert
...
def send_to_sp():
    '''
    Diese Mthode sendet alle entsprechend markierten Beratungen an die SP.
    Achtung: Da die Beratungsanlage vor dem File-Upload stattfindet kann es sein, dass teilweise die Dokumente nicht mitgesendet werden!
    '''
    from mvd.mvd.v2.api import create_beratungs_log
