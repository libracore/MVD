...
def prepare_mvm_for_sp(mitgliedschaft):
    ...
    prepared_mvm = {
        ...
        "adressen": adressen,
        "onlineHaftpflicht": 1 if mitgliedschaft.online_haftpflicht and mitgliedschaft.online_haftpflicht != '' else None,
        "onlineGutschrift": mitgliedschaft.online_gutschrift if mitgliedschaft.online_gutschrift and mitgliedschaft.online_gutschrift != '' else 0,
