...
frappe.ui.form.on('Addresschange', {
    setup: function(frm) {
		frm.show_submit_message = function() {};
	},
    refresh: function(frm) {
        if (frm.doc.docstatus === 0 && !frm.is_new()) {
            frm.set_intro(__(`
                Die Adressänderung ist gespeichert und wird automatisch am angegebenen Datum (Gültig ab) gebucht/wirksam.<br>
                Für eine sofortige Ausführung kann die Adressänderung manuell gebucht werden.
            `), "blue");
        }
    },
    plz: function(frm) {
