...
function import_payments(frm, einlesen, matchen, verbuchen, all_in_one) {
    cur_frm.set_value("status", "In Verarbeitung");
    cur_frm.save().then(function(){
        frappe.call({
            method: 'mvd.mvd.doctype.camt_import.camt_import.lese_camt_file',
