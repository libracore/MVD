...
def prepare_data():
	...
	# Das Feld wurde vom Bund umbenannt
	df = df.rename(columns={'PLZ4':'PLZ'})
	...
	df_original = df.copy() # brauchen wir um die gelöschten Einträge zu loggen
	...
	fehlende_plz = [['1001', 'VD'], ['1002', 'VD'], ['1014', 'VD'], ['1200', 'GE'], ['1211', 'GE'], ['1401', 'VD'], ['1704', 'FR'], 
		['1707', 'FR'], ['1708', 'FR'], ['1701', 'FR'], ['1951', 'VS'], ['2001', 'NE'], ['2004', 'NE'], ['2007', 'NE'], 
		['2009', 'NE'], ['2002', 'NE'], ['2003', 'NE'], ['2006', 'NE'], ['2302', 'NE'], ['2303', 'NE'], ['2301', 'NE'], 
		['2500', 'BE'], ['2501', 'BE'], ['3000', 'BE'], ['3001', 'BE'], ['3002', 'BE'], ['3003', 'BE'], ['3321', 'BE'], 
		['3401', 'BE'], ['3402', 'BE'], ['3601', 'BE'], ['3602', 'BE'], ['3607', 'BE'], ['4000', 'BS'], ['4002', 'BS'], 
		['4003', 'BS'], ['4004', 'BS'], ['4005', 'BS'], ['4007', 'BS'], ['4009', 'BS'], ['4010', 'BS'], ['4011', 'BS'], 
		['4012', 'BS'], ['4013', 'BS'], ['4015', 'BS'], ['4016', 'BS'], ['4018', 'BS'], ['4019', 'BS'], ['4020', 'BS'], 
		['4024', 'BS'], ['4025', 'BS'], ['4030', 'BS'], ['4032', 'BS'], ['4091', 'BS'], ['4501', 'SO'], ['4502', 'SO'], 
		['4503', 'SO'], ['4601', 'SO'], ['4801', 'AG'], ['4901', 'BE'], ['5001', 'AG'], ['5201', 'AG'], ['5401', 'AG'], 
		['5402', 'AG'], ['6000', 'LU'], ['6002', 'LU'], ['6160', 'LU'], ['6301', 'ZG'], ['6501', 'TI'], ['6506', 'TI'], 
		['6601', 'TI'], ['6604', 'TI'], ['6836', 'TI'], ['6901', 'TI'], ['6902', 'TI'], ['6903', 'TI'], ['6904', 'TI'], 
		['6905', 'TI'], ['6906', 'TI'], ['7001', 'GR'], ['7004', 'GR'], ['7006', 'GR'], ['7007', 'GR'], ['8000', 'ZH'], 
		['8010', 'ZH'], ['8080', 'ZH'], ['8021', 'ZH'], ['8022', 'ZH'], ['8023', 'ZH'], ['8024', 'ZH'], ['8027', 'ZH'], 
		['8031', 'ZH'], ['8033', 'ZH'], ['8034', 'ZH'], ['8036', 'ZH'], ['8039', 'ZH'], ['8040', 'ZH'], ['8042', 'ZH'], 
		['8058', 'ZH'], ['8061', 'ZH'], ['8063', 'ZH'], ['8088', 'ZH'], ['8090', 'ZH'], ['8091', 'ZH'], ['8092', 'ZH'], 
		['8093', 'ZH'], ['8099', 'ZH'], ['8201', 'SH'], ['8202', 'SH'], ['8204', 'SH'], ['8301', 'ZH'], ['8401', 'ZH'], 
		['8402', 'ZH'], ['8410', 'ZH'], ['8411', 'ZH'], ['8501', 'TG'], ['8502', 'TG'], ['8503', 'TG'], ['8612', 'ZH'], 
		['8613', 'ZH'], ['8622', 'ZH'], ['8639', 'ZH'], ['8813', 'ZH'], ['9001', 'SG'], ['9004', 'SG'], ['9006', 'SG'], 
		['9007', 'SG'], ['9013', 'SG'], ['9102', 'AR'], ['8238', 'SH'], ['6303', 'ZG'], ['7003', 'GR'], ['3024', 'BE'], 
		['3030', 'BE'], ['6908', 'TI'], ['6009', 'LU'], ['5232', 'AG'], ['6341', 'ZG'], ['9029', 'SG'], ['1709', 'FR'], 
		['8879', 'SG'], ['1811', 'VD'], ['3609', 'BE'], ['8070', 'ZH'], ['8071', 'ZH'], ['1631', 'FR'], ['3040', 'BE'], 
		['4040', 'BL'], ['6007', 'LU'], ['8759', 'GL'], ['9020', 'SG'], ['9026', 'SG'], ['6031', 'LU'], ['6021', 'LU'], 
		['6391', 'OW'], ['6281', 'LU'], ['6011', 'LU'], ['6061', 'OW'], ['6371', 'NW'], ['6431', 'SZ'], ['9471', 'SG'], 
		['9401', 'SG'], ['9501', 'SG'], ['4509', 'SO'], ['4070', 'BS'], ['6602', 'TI'], ['9201', 'SG'], ['8510', 'TG'], 
		['3050', 'BE'], ['8086', 'ZH'], ['8085', 'ZH'], ['2010', 'NE'], ['8285', 'TG'], ['4039', 'BS'], ['2510', 'BE'], 
		['1310', 'VD'], ['8098', 'ZH'], ['4620', 'SO'], ['8183', 'ZH'], ['8325', 'ZH'], ['8520', 'TG'], ['8343', 'ZH'], 
		['8087', 'ZH'], ['9024', 'SG'], ['4609', 'SO'], ['1818', 'VD'], ['1440', 'VD'], ['4034', 'BS'], ['4035', 'BS'], 
		['4089', 'BS'], ['8068', 'ZH'], ['3071', 'BE'], ['4033', 'BS'], ['3039', 'BE'], ['4042', 'BL'], ['8081', 'ZH'], 
		['8901', 'ZH'], ['3041', 'BE'], ['4041', 'BS'], ['4075', 'BS'], ['1019', 'VD'], ['6346', 'ZG'], ['3085', 'BE'], 
		['1300', 'VD'], ['4621', 'SO'], ['6590', 'TI'], ['1919', 'VS'], ['8096', 'ZH'], ['4808', 'AG'], ['4807', 'AG'], 
		['8011', 'ZH'], ['8060', 'ZH'], ['4809', 'AG'], ['8059', 'ZH'], ['3017', 'BE'], ['9301', 'SG'], ['8074', 'ZH'], 
		['3029', 'BE'], ['8012', 'ZH'], ['8970', 'ZH'], ['9023', 'SG'], ['1953', 'VS'], ['8030', 'ZH'], ['4604', 'SO'], 
		['2305', 'NE'], ['4028', 'BS'], ['8509', 'TG'], ['8403', 'ZH'], ['6302', 'ZG'], ['3802', 'BE'], ['8025', 'ZH'], 
		['8015', 'ZH'], ['4605', 'SO'], ['6591', 'TI'], ['7200', 'GR'], ['1960', 'VS'], ['4810', 'AG'], ['8018', 'ZH'], 
		['8017', 'ZH'], ['8920', 'ZH'], ['9021', 'SG'], ['8150', 'ZH'], ['5030', 'AG'], ['4134', 'BL'], ['8870', 'GL'], 
		['8300', 'ZH'], ['6131', 'LU'], ['4135', 'BL'], ['9321', 'TG']]
	...
	mvbl_plz_set = {
		2814, 2827, 4105, 4108, 4112, 4114, 4115, 4116, 4118, 4143, 4145, 4146, 4204, 4206, 4208, 
		4226, 4227, 4228, 4229, 4232, 4233, 4234, 4245, 4247, 4252, 4253, 4412, 4413, 4421, 4719
	}
	...
	# Alles nurnoch zum loggen der gelöschten Gemeinden
	gelöschte_zeilen = df_unduplicated[~df_unduplicated.index.isin(df_unique_plz.index)]
	gelöschte_zeilen = gelöschte_zeilen.merge(
        df_original[["Ortschaftsname"]], 
        left_index=True, 
        right_index=True, 
        how='inner'
    )
	gelöschte_zeilen = gelöschte_zeilen.rename(columns={"Kantonskürzel":"Kantonskürzel_gelöscht", "Sektion":"Sektion_gelöscht", "Ortschaftsname":"Ortschaftsname_gelöscht"})
	gelöschte_zeilen = gelöschte_zeilen.merge(
		df_unique_plz, on='PLZ', how='left'
	)
	gelöschte_zeilen = gelöschte_zeilen.rename(columns={"Kantonskürzel":"Kantonskürzel_gewählt", "Sektion":"Sektion_gewählt"})
	gelöschte_zeilen = gelöschte_zeilen[gelöschte_zeilen['Sektion_gelöscht'] != gelöschte_zeilen['Sektion_gewählt']] # uns interessierts nur, wenn die Sektion anders ist
	csv_content = gelöschte_zeilen.to_csv(index=False, sep=';', encoding='utf-8-sig')
	# wird als csv gespeichert im doctype file
	file_doc = frappe.get_doc({
		"doctype": "File",
		"file_name": "deleted_entries_sektio_plz_zuordnung.csv",
		"is_private": 1,
		"content": csv_content
	})
