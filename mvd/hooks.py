...
app_include_js = [
    "/assets/mvd/js/mvd.js",
    "/assets/mvd/js/vorlagen_baum/vorlagen_baum_navigator.js"
]
...
scheduler_events = {
    ...
    "all": [
        ...
        "mvd.mvd.doctype.beratung.beratung.send_to_sp", #2029: Pre-One-MVZH (Wird NACH GO-LIFE ENTFERNT)
